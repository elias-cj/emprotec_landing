...
export default function EditorialWhyUsSection() {
  ...
  return (
    <section id="nosotros" className="py-12 bg-slate-50 dark:bg-[#181818] text-slate-900 dark:text-white relative overflow-hidden transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-8">
        
        {/* Section Header */}
        <div className="max-w-3xl space-y-2">
          <span className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest text-[#4295DC] bg-white dark:bg-[#1F1F1F] px-4 py-1 rounded-full border border-slate-200/80 dark:border-neutral-800 shadow-sm">
          ...
          {concepts.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white dark:bg-[#1F1F1F] p-5 sm:p-6 rounded-2xl border border-slate-200/80 dark:border-neutral-800 shadow-lg flex flex-col justify-between space-y-4 group hover:border-[#4295DC] transition-all duration-300"
              >
                {/* Image Banner */}
